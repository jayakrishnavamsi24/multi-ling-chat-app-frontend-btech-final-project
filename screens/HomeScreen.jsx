  ...
  return (
    <View className="flex-1">
      <SafeAreaView className="flex-1">
        <View style={{paddingTop: 35}} className="w-full flex-row items-center justify-between px-4 py-4">
...
const MessageCard = ({ room }) => {
  ...
  return (
    <TouchableOpacity
      ...
      style={{borderStyle: 'solid', borderWidth: 1, borderColor: '#a7dde8', borderRadius: 30}}
      className="w-full flex-row items-center mt-3 mb-1 justify-start px-2 py-2 bg-slate-200"
    >
      {/* images */}
      ...
      <FontAwesome5 name="chevron-right" size={24} color="#555" style={{marginRight: 15}} />
    </TouchableOpacity>
  );
};
